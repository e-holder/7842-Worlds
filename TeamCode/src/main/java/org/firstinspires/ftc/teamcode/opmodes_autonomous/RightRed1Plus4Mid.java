...
public class RightRed1Plus4Mid extends LinOpAutonomousBase {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d IntakePosCone5 = new Pose2d(-49.2, 18.7, Math.toRadians(94.5));
        Pose2d ScoreCone5Pos = new Pose2d(-48.75, 2.0, Math.toRadians(124));
        Pose2d IntakePosCone4 = new Pose2d(-48.5, 20.25, Math.toRadians(94.5));
        ...
        Pose2d ParkZone1Pos = new Pose2d(-50.0, -21.0, Math.toRadians(90.0));
