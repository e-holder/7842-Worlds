...
public class RightRed1Plus4Mid extends LinOpAutonomousBase {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d IntakePosCone5 = new Pose2d(-50.1, 18.425, Math.toRadians(94.0));
        Pose2d ScoreConePos = new Pose2d(-50, 2.0, Math.toRadians(124));
        Pose2d IntakePosCone4 = new Pose2d(-49.1, 18.575, Math.toRadians(95.5));
        //ScoreConePos TODO: make different traj for all cone scoring
        Pose2d IntakePosCone3 = new Pose2d(-49.1, 18.675, Math.toRadians(94.5));
        //ScoreConePos TODO: make different traj for all cone scoring
        Pose2d IntakePosCone2 = new Pose2d(-49.1, 18.825, Math.toRadians(94.5));
        //ScoreConePos TODO: make different traj for all cone scoring
