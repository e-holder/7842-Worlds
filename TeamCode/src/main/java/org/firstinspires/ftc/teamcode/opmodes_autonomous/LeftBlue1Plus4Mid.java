...
public class LeftBlue1Plus4Mid extends LinOpAutonomousBase {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence WaitForDrop = m_vera.drivetrain.trajectorySequenceBuilder(PreloadConeScorePos).waitSeconds(1.0).build();
        TrajectorySequence WaitForDown = m_vera.drivetrain.trajectorySequenceBuilder(PreloadConeScorePos).waitSeconds(0.2).build();
        ...
        Trajectory IntakeCone5Traj = m_vera.drivetrain.trajectoryBuilder(PreloadConeScorePos).lineToLinearHeading(IntakePosCone5, IntakeVelo, ConstAccel).build();
        Trajectory IntakeCone4Traj = m_vera.drivetrain.trajectoryBuilder(PreloadConeScorePos).lineToLinearHeading(IntakePosCone4, IntakeVelo, ConstAccel).build();
        Trajectory IntakeCone3Traj = m_vera.drivetrain.trajectoryBuilder(PreloadConeScorePos).lineToLinearHeading(IntakePosCone3, IntakeVelo, ConstAccel).build();
        Trajectory IntakeCone2Traj = m_vera.drivetrain.trajectoryBuilder(PreloadConeScorePos).lineToLinearHeading(IntakePosCone2, IntakeVelo, ConstAccel).build();
